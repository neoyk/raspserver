...
foreach( $para as $entry)
{
	...
	{	
		echo "<a href=\"overdata.php?entry=$entry&type=$type&xaxis=$in&time1=$t1&time2=$t2&table=$entry$version&version=$version&mac=$mac&code=$code\">";
		echo "<img src=overfig.php?short=$short&entry=$entry&type=$type&xaxis=$in&yaxis=$in2&min=$in4&max=$in5&xzoom=$in6&yzoom=$in7&color=$in8&time1=$t1&time2=$t2&table=$entry$version&mac=$mac&code=$code /></a>\n";
	...
	{
		echo "<a href=\"raw.php?id=$id&code=$code&mac=$mac&type=$type&version=$version&$entry=1\">";
	...
	{
		echo "<a href=\"rawdata.php?id=$id&code=$code&mac=$mac&type=$type&version=$version&entry=$entry&xaxis=$in&time1=$t1&time2=$t2&table=perf_{$mac}_v$version\">";
